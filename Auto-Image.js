; (async () => {
  ...
  const TEXT = {
    ...
    es: {
      ...
      noColorsFound: "❌ ¡Abre la paleta de colores en el sitio web e inténtalo de nuevo!",
      ...
      positionSet: "✅ ¡Posición establecida exitosamente!",
      positionTimeout: "❌ Tiempo de espera para selección de posición",
      startPaintingMsg: "🎨 Iniciando pintura...",
      ...
      tokenReady: "✅ Generador de tokens listo - ¡ya puedes comenzar a pintar!",
      tokenRetryLater: "⚠️ El generador de tokens reintentará cuando sea necesario",
      resizeSuccess: "✅ Imagen redimensionada a {width}x{height}",
      paintingPaused: "⏸️ Pintura pausada en posición X: {x}, Y: {y}",
      captchaNeeded: "❗ Generación de token falló. Por favor, inténtalo de nuevo en un momento.",
      ...
      dataLoaded: "✅ Progreso cargado exitosamente",
      fileSaved: "✅ Progreso guardado en archivo exitosamente",
      fileLoaded: "✅ Progreso cargado desde archivo exitosamente",
      ...
      fileError: "❌ Error procesando archivo",
      ...
      themeSettingsDesc: "Elige tu tema de colores preferido para la interfaz.",
      languageSelectDesc: "Selecciona tu idioma preferido. Los cambios tendrán efecto inmediatamente.",
      autoCaptcha: "Solucionador Auto-CAPTCHA (Turnstile)",
      autoCaptchaDesc: "Genera automáticamente tokens Turnstile usando generador integrado. Recurre a automatización de navegador si es necesario.",
      applySettings: "Aplicar Configuración",
      settingsSaved: "✅ ¡Configuración guardada exitosamente!",
      speedOn: "Activado",
      speedOff: "Desactivado",
      cooldownSettings: "Configuración de Enfriamiento",
      waitCharges: "Esperar hasta que las cargas alcancen",
      captchaSolving: "🔑 Generando token Turnstile...",
      captchaFailed: "❌ Generación de token Turnstile falló. Intentando método alternativo...",
      automation: "Automatización",
      noChargesThreshold: "⌛ Esperando que las cargas alcancen {threshold}. Actualmente {current}. Próxima en {time}...",
    },
  }
        ...
        <div style="margin-bottom: 25px;">
          ...
          <div style="background: rgba(255,255,255,0.1); border-radius: 12px; padding: 18px; border: 1px solid rgba(255,255,255,0.1);">
            ...
            ">
              ...
              <option value="es" ${state.language === 'es' ? 'selected' : ''} style="background: #2d3748; color: white;">🇪🇸 Español</option>
